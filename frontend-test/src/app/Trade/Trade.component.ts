...
export class TradeComponent implements OnInit {
  ...
  soybean = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.soychain.mynetwork.Trade',
      'soybean': this.soybean.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.soybean) {
        formObject.soybean = result.soybean;
      } else {
        formObject.soybean = null;
      }
